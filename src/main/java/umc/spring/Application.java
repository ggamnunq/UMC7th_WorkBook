...
//
//			missionService.findMyMissionsByStatus(memberId, status, offset)
//					.forEach(System.out::println);
//
//		};
//
...
//
//			List<Mission> challengingMissions = missionService.findMissionsForHomePage(memberId, regionId, MissionStatus.CHALLENGING, offset);
//			List<Mission> completedMissions = missionService.findMissionsForHomePage(memberId, regionId, MissionStatus.COMPLETE, offset);
//			System.out.println("미션 목록");
//			challengingMissions.forEach(System.out::println);
//			System.out.println();
//			System.out.println("해당 지역 미션 수행 수 : " + completedMissions.size());
////			System.out.println("해당 지역 미션 수행 수 : " + missionService.getMissionCount(memberId, regionId));
//
//		};
//
//	}
