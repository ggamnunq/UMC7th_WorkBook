...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ExceptionAdvice(@Qualifier("webRequest") WebRequest webRequest, View error) {
    ...
    public ResponseEntity<Object> exception(GeneralException generalException, HttpServletRequest request) {
